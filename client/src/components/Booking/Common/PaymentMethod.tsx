...
interface PaymentMethodProps {
  ...
  showBankTransfer?: boolean; // Activity không dùng chuyển khoản
}
...
export default function PaymentMethod({
  ...
  const totalOptions = (showCash ? 1 : 0) + (showBankTransfer ? 1 : 0) + 2; // +2 for MoMo and ZaloPay
  ...
  return (
    <div className="mb-6">
      ...
      <div className={`grid grid-cols-1 md:grid-cols-${totalOptions} gap-4`}>
        {showCash && (
          <div
