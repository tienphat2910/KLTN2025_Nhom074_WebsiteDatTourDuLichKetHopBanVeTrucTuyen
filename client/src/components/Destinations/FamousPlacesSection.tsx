...
const FamousPlacesSection: React.FC<FamousPlacesSectionProps> = ({
  places,
  destinationName,
}) => {
  ...
  }, [places, updateScrollButtons, handleMouseMove, handleMouseUp, handleMouseLeave, handleTouchMove, handleTouchEnd]);
    ...
    <section className="mb-8">
      <div className="flex items-center justify-between mb-4">
        <h3 className="text-xl font-bold text-gray-800">
          Địa điểm du lịch nổi tiếng ở {destinationName}
        </h3>
