    ...
    <div className="lg:col-span-1 sticky top-24">
      ...
      >
        ...
        <button
          ...
          className="w-full bg-blue-600 text-white font-semibold py-4 md:py-4 rounded-lg hover:bg-blue-700 hover:shadow-lg transform hover:scale-105 transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none text-base md:text-base"
        >
