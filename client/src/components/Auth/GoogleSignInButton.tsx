...
export function GoogleSignInButton({
  ...
  return (
    <button
      ...
      disabled={isLoading}
      className="group relative w-full bg-white border-2 border-gray-300 text-gray-700 px-4 py-3 rounded-lg 
                 transition-all duration-300 ease-out
                 hover:border-blue-500 hover:shadow-lg hover:shadow-blue-100 hover:-translate-y-0.5
                 active:translate-y-0 active:shadow-md
                 disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:translate-y-0 disabled:hover:shadow-none
                 flex items-center justify-center space-x-3 font-medium
                 overflow-hidden"
    >
